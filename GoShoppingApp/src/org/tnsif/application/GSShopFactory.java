...
public class GSShopFactory extends ShopFactory {
	...
	@Override
	public NormalAcc getNewNormalAcc(int accno, String accnm, float charges, float delieveryCharges) {
		GSNormalAcc n=new GSNormalAcc(accno,accnm,charges,delieveryCharges);
		return n;
	}
